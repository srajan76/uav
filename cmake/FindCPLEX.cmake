if(APPLE)
    ...
    file(GLOB dirs $ENV{HOME}/ILOG/CPLEX_Studio128)
    foreach(d in ${dirs})
...
if(APPLE)
    string(CONCAT CPLEX_DIR $ENV{HOME}/ILOG/CPLEX_Studio;${CPLEX_VERSION};/cplex)
    string(CONCAT CONCERT_DIR $ENV{HOME}/ILOG/CPLEX_Studio;${CPLEX_VERSION};/concert)
elseif(UNIX)
